...
- [API/KubeJS#machinerecipeschema](../API/KubeJS#machinerecipeschema) — 数据驱动配方字段全集。- [JavaAPI/合金炉](../JavaAPI/合金炉) — 同一台合金炉的 Java 实现。
- [高炉](高炉) — 不使用修饰器的基础机器。
- [太空电梯](太空电梯) — 上一节 HOST + MODULE 教程。