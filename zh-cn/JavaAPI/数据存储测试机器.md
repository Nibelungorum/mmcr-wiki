...
- `C` 是控制器，与 [BLAST_FURNACE](../JavaAPI/高炉) 的布置方式一致。
...
[NETWORK_PRODUCER_MACHINE](../JavaAPI/算力生产者) 与 [NETWORK_CENTER_MACHINE](../JavaAPI/网络中心) 还涉及网络层 API，列表见那两篇教程的对应章节。