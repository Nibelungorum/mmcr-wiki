...
- **`cn.howxu.mmcr.api.publicapi.data.DataStorage`** / **`DataValue`** — 详见 [DATA_STORAGE_MACHINE](../JavaAPI/DATA_STORAGE_MACHINE) 教程的对应章节。注意 `DataStorage` 是公共视图，通过 `DataStorage.view(Object)` 工厂构造。